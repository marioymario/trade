...
from files.research.entry_quality_cross_asset_characterization import (
    SourcePair,
    build_entry_quality_cross_asset_characterization,
)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Build generalized cross-asset entry-quality "
            "characterization for the policy-derived "
            "Universe V1 PRIMARY_COMPARABLE population."
        )
    )
